...
class ConstraintsTableRow(Row):
    ...
    def __init__(self,
                 constr_type: Optional[ConstrTypeOptions] = ConstrTypeOptions(),
                 constr__lp__1__rp__: Optional[string] = None,
                 constr__lp__2__rp__: Optional[string] = None,
        ...
        **constr_target**: float
        ...
        self._constr__lp__1__rp__: Optional[string] = constr__lp__1__rp__
        self._constr__lp__2__rp__: Optional[string] = constr__lp__2__rp__
    ...
    @property
    def constr__lp__1__rp__(self) -> string:
        """
        Info:
        ================
    ...
    def constr__lp__1__rp__(self, value: string):
        self._constr__lp__1__rp__ = value

    @property
    def constr__lp__2__rp__(self) -> string:
        """
        Info:
        ================
    ...
    def constr__lp__2__rp__(self, value: string):
